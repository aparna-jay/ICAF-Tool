                                        ...
                                        <div className="panel-heading">
                                            <div className="row">
                                                ...
                                                <div className="col col-xs-6 text-right">
                                                    <a type="button"
                                                       className="btn btn-sm btn-success btn-create"
                                                       href="/ReviewerRegister">Add
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        <tr>
                                                            <td key={"adminSettings"} align="center">
                                                                <a className="btn btn-default"><em
                                                                    ...
                                                                    onClick={() => onEditClick(reviewer._id)}/></a>
                                                                <a className="btn btn-danger"><em
                                                                    ...
                                                                    if (window.confirm("Are you sure you want to delete this reviewer?")) {
                                                                        deleteReviewer(reviewer._id)
                                                                    }
                                                                    ;
                                                                }}></em></a>
                                                            </td>
                                                            <td key={"reviewer.Name"}
                                                                className="hidden-xs">{reviewer.Name}</td>
