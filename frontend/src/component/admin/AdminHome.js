                                            ...
                                            <div className="col-md-12">
                                                <div className="row">
                                                    <div className="col">
                                                        ...
                                                        <input className="form-control" type="text" placeholder={admin.Name} onChange={nameSetter} />
                                                    </div>
                                                ...
                                                <div className="row">
                                                    <div className="col">
                                                        ...
                                                        <input className="form-control" type="email" placeholder={admin.Email} onChange={emailSetter} />
                                                    </div>
                                                </div>
                                                <br />
                                                <div className="row">
