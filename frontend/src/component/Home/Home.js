                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-12 text-center" id="home">
                                    <br/><br/><br/>
                                    <h1 className="text-uppercase section-heading">International Conference on
                                        Application Frameworks - 2021</h1>
                                    ...
                                    <figure className="snip1527">
                                        ...
                                        <figcaption>
                                            <div className="date"><span
                                                className="day">{conference.Start_date.split("T")[0]}</span></div>
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-12 text-center">
                                    ...
                                    <h4 className="text-muted section-subheading">Here are some of our Keynote Speakers
                                        ... </h4>
                                </div>
                            </div>
                                                    ...
                                                    <div className="card-container-imagia">
                                                        <div className="card-imagia">
                                                            <div className="front-imagia">
                                                                ...
                                                                <div className="user-imagia"><img className="img-circle"
                                                                                                  alt=""
                                                                                                  src={keynotes.avatar}/>
                                                                </div>
                                                                <div className="content-imagia">
                                                                    ...
                                                                    <p className="text-center">
                                                                        <em>{keynotes.Organization} </em></p>
                                                                </div>
                                                                <div className="footer-imagia"><span><i
                                                                    className="fa fa-plus"></i> More info</span>
                                                                </div>
                                                            </div>
                                                            <div className="back-imagia">
                                                                <div className="content-imagia content-back-imagia">
                                                                    <div>
                                                                        ...
                                                                        <p className="text-center">
                                                                            <em>{keynotes.Description} </em></p>
                                                                    </div>
                                                                </div>
                                                                <div className="footer-imagia">
                                                                    <div className="social-imagia text-center"><a
                                                                        href="#"><i
