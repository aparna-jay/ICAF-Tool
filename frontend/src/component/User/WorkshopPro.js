                        ...
                        <div className="">
                            ...
                            <div className="form-group mb-3">
                                ...
                                <input className="form-control" type="name" autoComplete="off" required=""
                                       name="Password" value={Workshop.Password}/>
                            </div>
                            <div className="row">
                                <div className="col-md-12 text-center content-right">
                                    <a href={"/WorkshopStatus"} className="btn btn-success form-btn" type="submit">Check
                                        Status</a>
                                    <a href={"/WorkshopUpdate"} className="btn btn-warning form-btn" type="reset">Update
                                        Profile</a>
