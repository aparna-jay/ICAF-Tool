        ...
        <div>
            <div className="contact-clean bg-white">
                <form>
                    ...
                    <div className="col"><label>Enter Name</label><input className="form-control" type="text"
                    ...
                    <div className="form-group">
                        ...
                        <div className="col"><label>Enter Date</label><input className="form-control" type="date"
                                                                             onChange={DateSetter}/>
                        </div>
                        <div className="col"><label>Enter Time</label><input className="form-control" type="time"
                                                                             onChange={TimeSetter}/>
                        </div>
                        <div className="col"><label>Enter BankName</label><input className="form-control" type="text"
                                                                                 onChange={BankNameSetter}/>
                        </div>
                        <div className="col"><label>Enter CardType</label><input className="form-control" type="text"
                                                                                 onChange={CardTypeSetter}/>
                        </div>
                        <div className="col"><label>Enter CCNumber</label><input className="form-control" type="text"
                                                                                 onChange={CCNumberSetter}/>
                        </div>
                        <div className="col"><label>Enter CVV</label><input className="form-control" type="text"
                                                                            onChange={CVVSetter}/>
                        </div>
